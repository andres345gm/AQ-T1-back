...
class PurchaseCrudUseCase:
    ...
    def create_purchase(self, pokemon_id: id, date: datetime, price: int) -> Purchase:
        purchase = Purchase(0, pokemon_id, date, price)
    ...
    def update_purchase(self, purchase_id: int, pokemon_id: id, date: datetime, price: int) -> Optional[Purchase]:
        purchase = Purchase(purchase_id, pokemon_id, date, price)
